...
export async function POST(req) {
  try {
    ...
    const { kundenname, telefonnummer, link, text } = body || {};
    ...
    const smsText =
      typeof text === "string" && text.trim().length > 0
        ? text
        : `Hallo ${kundenname}, vielen Dank für Ihren Besuch! Wir würden uns sehr über eine kurze Google-Bewertung freuen: ${googleLink}. Diese Nachricht kommt nur einmal – versprochen! 😊`;
